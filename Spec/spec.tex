...
Observations : 
	...
	[(*$\specB{ramasser\_objet}$*)]
		...
		est_equipe_objet(ramasser_objet(P,objet)) = true
	[(*$\specB{ramasser\_perso}$*)]
		perso_equipe(ramasser_perso(P,perso)) = perso 
		est_equipe_perso(ramasser_perso(P,perso)) = true
	[(*$\specB{jeter}$*)]
		est_equipe_objet(jeter(P)) = false 
                est_equipe_perso(jeter(P)) = false 
...
Observations :
      ...
      [(*$\specB{modifier_bloc}$*)]
            modifier_bloc(init(l, h, p), x, y, z) = 
