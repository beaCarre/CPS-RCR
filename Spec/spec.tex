...
Observations : 
      [(*$\specB{Invariants}$*)]
      	...
      	Personnage::largeur(p1)/2 + Personnage::largeur(p2)/2) > positionX(G,p1)-positionX(G,^p2)
      	(*$\land$*) Personnage::hauteur(p1)/2 + Personnage::hauteur(p2)/2) > positionZ(G,p1)-positionZ(G,p2) 
      	(*$\land$*) Personnage::profondeur(p1)/2 + Personnage::profondeur(p2)/2) > positionY(G,p1)-positionY(G,p2)  
	...
	gangsters(init()) = {Personnage::init("???",10,10,10,100,100,0)}, (*$\forall$*) g (*$\in$*) gangsters(G)
