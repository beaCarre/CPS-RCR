...
Observations : 
      [(*$\specB{Invariants}$*)]
      	...
      	collision(G,id1,id2)  (*$\stackrel{min}{=}$*) collision(G,id2,id1)
	...
	gangstersNoms(init()) = { "Slick", "Machin", "Bidule", ...}
	gangsters(init()) = {Personnage::init(g,10,10,10,100,100,0) , (*$\forall$*) g (*$\in$*) gangstersNoms(G)}
	estGele(init(), s) = false (*$\forall$*) s (*$\in$*) gangstersNoms()
	estGele(init(), "Alex") = false
	estGele(init(), "Ryan") = false
	estFrappe(init(), s) = false (*$\forall$*) s (*$\in$*) gangstersNoms()
	estFrappe(init(), "Alex") = false
	estFrappe(init(), "Ryan") = false
